...
for filename in os.listdir(input_folder):
    # determine the file path of the current file in the for-loop
    input_file_path = os.path.join(input_folder, filename)
    output_file_name = os.path.join(output_folder, f'{os.path.splitext(filename)[0]}_scrunched.{extension}')
